      ...
      <div className="sm:text-center lg:text-left">
        ...
        <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-lg lg:mx-0">
          ...
          <span className="block xl:inline">
            Oldstitch Zhejiang Lanhong Textile Technology Co., LTD Dhaka Office:
            Level #2, House # 18, Road #10, Sector #1, Uttara, Dhaka-1230
            <br />
            <br />
            Phone: +8801784393953, Email: info@lanhongtextile.com
            <br />
            <br />
            Zhejiang Office: Room 701, Building 1, Conan Business Center, Keqiao
            District, Shaoxing, Zhejiang Dongguan Office: 145 Renmin North Road,
